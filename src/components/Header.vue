  ...
  <div>
    ...
    <v-toolbar flat dense color='transparent' scroll-off-screen>
      ...
      <v-toolbar-title class='headline'>
        <span class='font-weight-light'>Ringson</span>
        <span class='green--text'>Mukosha</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <v-toolbar-items class='hidden-sm-and-down'>
        ...
        <v-btn flat to='/services' active-class='green--text headline'
          >Services</v-btn
        >
        <v-btn flat to='/projects' active-class='green--text headline'
          >Projects</v-btn
        >
        <v-btn flat to='/contact' active-class='green--text headline'
          >Contact</v-btn
        >

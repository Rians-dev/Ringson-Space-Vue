          ...
          <template v-slot:activator='{ on }'>
            <v-flex xs12 sm6 md4 lg4 xl4 v-on='on'>
              <v-card hover flat color='transparent'>
                ...
                <v-card-title primary-title class='justify-center'>{{project.des}}</v-card-title>
              </v-card>
            </v-flex>
          </template>
      ...
      return {
        ...
        projects: [
          ...
          },
          {
            dialog: false,
            title: 'Siyafunda',
            des: "A children's ISIZULU Leaning App with the main goals of vocabulary development, creativity and basic literacy.",
            tech: {
              tech1: 'Jetpack Compose',
              tech2: 'Kotlin',
              tech3: 'KobToolBox'
          ...
          },
          {
            dialog: false,
            title: 'Digitres App',
            des: "A Mobile App designed and developed to Secure, Manage and Trace items as well buying and selling authentic gudgets.",
            tech: {
              tech1: 'Flutter',
              tech2: 'Dart',
              tech3: 'Firebase'
